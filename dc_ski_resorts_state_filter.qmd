---
title: "Ski Resorts Near Washington, DC"
subtitle: "Interactive Map with MapLibre"
format: 
  html:
    page-layout: article
    toc: true
...
- **Layer Control**: Click the layers icon (📋 top-left) to toggle drive time zones on/off
- **Drive Time Zones** (optional layers):
  - 🔵 2hr/100mi (blue) | 🟢 3hr/150mi (green) | 🟡 4hr/200mi (yellow) | 🔴 5hr/250mi (red)
