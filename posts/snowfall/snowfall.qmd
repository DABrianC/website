...
plot <- ggplot(df3_snow) +
  geom_jitter(aes(x = month,
              ...
              width = .25,
              size = 4) +
  geom_smooth(aes(x = month, y = amount)) +
...
Using Plotly from R is pretty easy with an existing ggplot object. We've already defined our ggplot object as `plot` above. We can simply pass this to plotly and we get an interactive data visualiztion. Pretty cool! 
