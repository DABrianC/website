...
subtitle: "Part 2:Cleaning up the snowfall with a geom_smooth()_plow"
categories: [R, ggplot]
date: "2025-11-21"
...
source(here::here("posts/snowfall/snowfall_alta.R"))
```
...
*This repeats the first step from [last post](https://dabrianc.github.io/website/posts/snowfall/snowfall.html) so no need to redo it if you are working in the same project*
