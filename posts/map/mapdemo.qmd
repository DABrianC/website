...
For this exercise, the data is already saved in the main project folder so I'll read in the csv file with city names and locations, and then I'll read in the administrative boundaries. [You can also access the city data here](https://github.com/DABrianC/website/blob/main/posts/map/Madagascar_Cities.csv) and [the administrative boundaries here](https://github.com/DABrianC/website/tree/main/posts/map/shapefiles).
...
tmap::tmap_mode("plot") +
  ...
  tmap::tm_dots(size = "Population", col = "red"
